...
uses REAbout, RichEdit, ShellAPI, ReInit, recalc;

resourcestring
  sSaveChanges = 'Salvar alterações em %s?';
  sOverWrite = 'OK para sobreescrever %s';
  sUntitled = 'Sem título';
  sModified = 'Modificado';
  sColRowInfo = 'Linha: %3d   Col: %3d';
